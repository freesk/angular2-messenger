...
const styles_MessageComponent:any[] = ['.username[_ngcontent-%COMP%] {\n        display: inline-block;\n        font-style: italic;\n        font-size: 12px;\n        width: 80%;\n    }\n    .config[_ngcontent-%COMP%] {\n      display: inline-block;\n      text-align: right;\n      font-size: 12px;\n      width: 19%;\n    }'];
...
class _View_MessageComponent0 extends import1.AppView<import3.MessageComponent> {
  ...
  createInternal(rootSelector:string):import2.AppElement {
    ...
    this.renderer.setElementAttribute(this._el_7,'class','username');
...
export function viewFactory_MessageComponent0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement):import1.AppView<import3.MessageComponent> {
  if ((renderType_MessageComponent === (null as any))) { (renderType_MessageComponent = viewUtils.createRenderComponentType('/Users/Dmitry/Documents/Programming/typescript/lessons/angular2-messenger/assets/app/messages/message.component.html',0,import9.ViewEncapsulation.Emulated,styles_MessageComponent,{})); }
