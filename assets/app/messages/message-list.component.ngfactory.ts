...
class _View_MessageListComponent0 extends import1.AppView<import3.MessageListComponent> {
  ...
  createInternal(rootSelector:string):import2.AppElement {
    ...
    this._TemplateRef_7_5 = new import12.TemplateRef_(this._appEl_7,viewFactory_MessageListComponent1);
...
export function viewFactory_MessageListComponent0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement):import1.AppView<import3.MessageListComponent> {
  if ((renderType_MessageListComponent === (null as any))) { (renderType_MessageListComponent = viewUtils.createRenderComponentType('/Users/Dmitry/Documents/Programming/typescript/lessons/angular2-messenger/assets/app/messages/message-list.component.ts class MessageListComponent - inline template',0,import9.ViewEncapsulation.None,styles_MessageListComponent,{})); }
